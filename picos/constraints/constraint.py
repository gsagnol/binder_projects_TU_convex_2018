...
class Constraint(ABC):
    ...
    Implementations
        ...
        * are supposed to call :meth:`Constraint.__init__` from within their own
          implementation of `:meth:__init__`.
    """
    LE = "<"
    GE = ">"
    EQ = "="
    ...
    def copy_with_new_vars(self, newVars, newCons = None):
        ...
        from ..tools import _copy_exp_to_new_vars
        ...
        for name in self._expression_names():
            ...
            newExpression = _copy_exp_to_new_vars(expression, newVars)
...
class MetaConstraint(Constraint):
    ...
    Implementations
        ...
        * are supposed to receive or construct a temporary problem containing
          ...
          (along with a number of standard parameters that are dispatched to
          :meth:`Constraint.__init__`) from within their own implementation of
          `:meth:__init__`.
    """
